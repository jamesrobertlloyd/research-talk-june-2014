...
\begin{frame}{A nonparametric approach}
  \begin{itemize}
    \item Instead of defining a statistic parametrically to identify a discrepancy, we pick the statistic that most shows any discrepancy from some function space
    \vspace{\baselineskip}
